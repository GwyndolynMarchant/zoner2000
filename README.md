...
- [Mailto](https://en.wikipedia.org/wiki/Mailto) for [comments](#mailto-comments)
...
### Mailto Comments
By adding a mailto link into your footer, you can add support for your readers to email you in response to your post! Simply add any mailto link, and when building your blog it will automatically be tweaked on each post to prefill an "re: {POST TITLE}" subject line and a body to fruitlessly dissuade spammers.
...
## Running
To get up and running as fast as possible, copy the contents of the "example" folder to wherever you want, and use that as your base for your new blog! Ryan Trawick wrote [an excellent visual "How?" guide on his site](https://zone-builder.neocities.org/#content), so please check it out! My scaffolding includes some default themeing and framework elements for the additional features I added in Zoner2000.
